...
<h2> What permissions does this workflow need? </h2>

As can be seen in the example above, the workflow needs the following <ins>**write**</ins> permissions:
...
Setting one of these to **true** will mean the chosen workflow category files <ins>will be included</ins> in future workflow run pull requests<br>
Setting one of these to **false** will mean the chosen workflow category files <ins>will not be included</ins> in any future workflow run pull requests.
